...
class DashboardService:
    ...
    def _get_user_daily_balance_history(self, user_all_balance_list):
    ...
    def _get_asset_type_ratio_tuple_list(self, user_holdings_list):
    ...
    def get_dashboard_context(self):
        ...
        asset_ratio = self._get_asset_type_ratio_tuple_list(self.user_holdings_list)

        asset_type_ratio_tuple_list_json = json.dumps(asset_ratio, default=str)
        top_asset_type_allocation = asset_ratio[0]
        
        user_daily_balance_history = self._get_user_daily_balance_history(self.all_balances)
